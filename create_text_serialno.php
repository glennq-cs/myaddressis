...
$results = $_SESSION['results'][$_GET['id']];
...
//write text to file
$txtPost = "You entered: ".$results['post_serial']."\n";
// fwrite($textFile, $txtPost);
$txtText = "Correct serial number: ".$results['text_serial']."\n";
...
header("Content-Disposition: attachment; filename=Text_SerialNo_Result_{$_GET['id']}.txt");
